    ...
    return (
        <div className='mt-6'>
            ...
            <form action={formAction} className='mt-4'>
                ...
                <div className='mt-6'>
                    <button type='submit' className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800'>Book Room</button>
                </div>
            </form>
        </div>
    )
