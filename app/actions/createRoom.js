...
async function createRoom(previousState, formData) {
    ...
    try {
        ...
        } else { console.log('No image file provided or file is invalid'); }

        // Create room
        await databases.createDocument(process.env.NEXT_PUBLIC_APPWRITE_DATABASE,process.env.NEXT_PUBLIC_APPWRITE_COLLECTION_ROOMS,ID.unique(),
            {
                user_id: user.id,
